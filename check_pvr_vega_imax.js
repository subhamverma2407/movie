...
const URL =
  "https://www.district.in/movies/pvr-vega-city-bannerghatta-road-bengaluru-in-bengaluru-CD1022309?fromdate=2026-03-19";
...
async function checkWebsite() {
  ...
  try {
    ...
    if (hasDate) {
      ...
      const message = `
  ${isLocal ? "LOCAL SERVER" : isUbuntuServer ? "UBUNTU SERVER" : "GITHUB ACTION"}: IMAX PVR VEGA CITY Whitefield - Slot detected for Dhurandhar: The Revenge on 19th March`;
